	...
	public static void main(String[] args) {
		...
		for (String cls : inputClasses) {
			...
			try {
                 ...
                 * As this is one of the main things that can go wrong when instrumenting, here are reasons why it might fail:
                 * 1. If the RuntimeException message contains "JSR/RET" it can be related to a particular construct in the bytecode that
				 ...
				 * 2. Unmet dependencies with NoClassDefFoundError. To fix this, add the jar with the class to the Java classpath.
                 *    However, in practice if you get this warning only once or twice, this might not make a big difference.
				 */
